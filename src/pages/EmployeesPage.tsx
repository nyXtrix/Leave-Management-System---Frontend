...
const MOCK_EMPLOYEES: UserProfile[] = [
  {
    id: "e1",
    name: "Sarah Lee",
  ...
  },
  {
    ...
    role: "EMPLOYEE",
    avatar:
      "https://ui-avatars.com/api/?name=Tom+Fisher&background=34d399&color=fff",
    joinDate: "2023-06-12",
    status: "INACTIVE",
    tenantId: "acme-01",
  },
      ...
      render: (_val, row) => (
        <div className="flex items-center gap-4 py-1.5">
          ...
          <div className="min-w-0">
            ...
            <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mt-1.5 truncate group-hover:text-indigo-600 transition-colors">
              {row.email}
            </p>
          </div>
        </div>
    ...
    },
    {
      ...
      render: (val) => (
        <Badge
          ...
          className="px-3 py-1 font-black text-[9px] uppercase tracking-[0.2em] rounded-full"
        >
          {String(val)}
        </Badge>
      ),
