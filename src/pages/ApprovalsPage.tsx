...
const MOCK_PENDING: LeaveRequest[] = [
  {
    ...
    notes: "Severe flu, doctor recommended rest",
  },
  {
    id: "2",
    employeeId: "e5",
  ...
  const COLUMNS: Column<LeaveRequest>[] = [
    ...
    },
    {
      ...
      render: () => (
        <Badge
          variant="warning"
          className="px-3 py-1 rounded-full font-black text-[10px] uppercase tracking-widest gap-2 bg-amber-50 text-amber-600 border-amber-200/50 shadow-sm"
        >
